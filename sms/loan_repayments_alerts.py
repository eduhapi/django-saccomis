...
from myapp.utils import send_notification  # Adjust the import path as necessary
            ...
            for account in member_accounts:
                ...
                for loan in issued_loans:
                    ...
                    if today == reminder_date:
                        ...
                        phone_number = account.member.phone_number  # Assume member has a phone_number field
                        message = (
                            f"Reminder: Your loan installment of {loan.installment_amount} is due on {due_date}. "
                            f"Outstanding amount: {account.loan}. Please make your payment on time."
                        )
